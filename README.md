...
**Listen to a podcast about this rocket simulation program by clicking play below (unmute audio).**
...
- **Thrust Forces**: Generated by the rocket's thrusters, allowing it to accelerate in the direaction it is facing.
